...
export default function EditDeveloperPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    useEffect(() => {
        ...
        developersApi
            ...
            .then((data) => {
                setDeveloper(data);
                setName(data.name ? formatDeveloperName(data.name) : '');
                setLocation(data.location ? formatLocationName(data.location) : '');
                setEmail(data.email ?? '');
                setPhone(data.phone ?? '');
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            setName(updated.name ? formatDeveloperName(updated.name) : '');
    ...
    if (authorized === false) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-gray-400">You do not have permission to edit developers.</p>
    ...
    if (notFound || !developer) {
        return (
            <div className="flex flex-col items-center justify-center min-h-[60vh] gap-4">
                ...
                <p className="text-gray-400">The developer you are looking for does not exist.</p>
    ...
    return (
        <div className="animate-in fade-in duration-500 max-w-4xl mx-auto space-y-6">
            ...
            <div>
                ...
                {success && (
                    <div className="bg-green-500/20 border border-green-500 text-green-300 px-4 py-3 rounded-xl mb-6 flex items-center gap-3 text-sm">
